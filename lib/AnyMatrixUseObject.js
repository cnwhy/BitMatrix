...
(function (factory) {
    ...
    "use strict";
    var Matrix_I_1 = __importDefault(require("./Matrix.I"));
    var AnyMatrixUseObject = /** @class */ (function (_super) {
        ...
        AnyMatrixUseObject.prototype.cellForEach = function (fn) {
            var _a = this, _data = _a._data, width = _a.width, _length = _a.total;
            var x = 0, y = 0;
        ...
        AnyMatrixUseObject.prototype.showView = function () {
